...
npm run verify         # Full gate: format:check + lint + typecheck + typecheck:scripts/tests/bench/tooling + lint:types + sim-boundary + asset-path + e2e-geometry + layout-discipline + ant-cycle guards + tests
